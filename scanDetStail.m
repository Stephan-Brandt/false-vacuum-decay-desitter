...
(* Receives three parameters from the command line, ell, sMin, sMax *)
...
Export[StringJoin["greenSparam-",ToString[ellMin],"-",ToString[sMin],"-",ToString[sMax],".csv"],reconstructed] (* ;]; *)
];
